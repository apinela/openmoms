...
@RestController
@RequestMapping("/api/open-moms-kafka")
public class OpenMomsKafkaResource {
    private final Logger log = LoggerFactory.getLogger(OpenMomsKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public OpenMomsKafkaResource(KafkaProperties kafkaProperties) {
